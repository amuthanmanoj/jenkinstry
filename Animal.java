...
public class Animal {
	...
	public Animal(){
		...
		numberOfAnimals++;
		System.out.println("Into Animal Consutructor");
	...
	public void setUniqueID() {
		...
		this.uniqueID = minNumber + (long)(rand * maxNumber);
	...
	protected static void countTo(int startingNumber){
		...
		System.out.println("in count to method");
	...
	public static void main(String[] args){
		...
		System.out.println("Inside main menthod");
